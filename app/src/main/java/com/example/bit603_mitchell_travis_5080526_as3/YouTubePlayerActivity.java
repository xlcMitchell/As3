...
public class YouTubePlayerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //so the video only plays when it is visible
    ...
    public String extractVideoIdFromUrl(String url) {
        ...
        Log.d("YOUTUBE_LINK","youtubeLinkWithoutProtocolAndDomain: " + youTubeLinkWithoutProtocolAndDomain);
        ...
        for (String regex : videoIdRegex) {
            ...
            Log.d("YOUTUBE_LINK","matcher" + matcher);
            if (matcher.find()) {
    ...
    private String youTubeLinkWithoutProtocolAndDomain(String url) {
        ...
        Log.d("YOUTUBE_LINK","url before returning in ytlinkwithoutprotocol func" + url);
        return url;
    }
    ...
    private void playVideo(YouTubePlayer player) {
        Log.d("YOUTUBE_LINK", "videoId in playVideo function" + videoId); //check id
